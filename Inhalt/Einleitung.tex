...
Ergebnisse erforderlich sind. Daran anschließend ordnet Kapitel~\ref{cha:verwandteArbeiten} die Arbeit in den Stand der Forschung ein und diskutiert relevante Ansätze 
aus der Trajektorienmodellierung sowie dem physikinformierten maschinellen Lernen.
...
die Evaluation abgeleitet. Kapitel~\ref{cha:methodik_und_modelle} beschreibt darauf aufbauend die Methodik: Es werden die synthetische Datengenerierung, die 
konzipierten Modellansätze sowie das Experimentdesign zur vergleichenden Bewertung der Modelle erläutert.
