...
Diese Arbeit zielt auf eine datenbasierte Analyse von Basketball-Freiwürfen unter kontrollierten Bedingungen ab. Da kein geeigneter realer Datensatz zur Verfügung 
...
\begin{itemize}
    \item \textbf{Trajektorienvorhersage aus variierenden Eingaberepräsentationen} 
    \item \textbf{Parameterrekonstruktion als inverse Modellierung} 
    \item \textbf{Wurfklassifikation der vorhergesagten Trajektorien in die Kategorien „zu kurz“, „Treffer“ und „zu lang“}
\end{itemize}
...
Die Arbeit beginnt in Kapitel~\ref{cha:grundlagen} mit der Darstellung der theoretischen Grundlagen, welche alle Konzepte abdecken, die für das Verständnis und 
Interpretation der Ergebnisse relevant sind. In Kapitel~\ref{cha:verwandteArbeiten} werden verwandte Arbeiten aus dem Bereich vorgestellt, in dem sich die 
vorliegende Arbeit einordnet. Kapitel~\ref{cha:problemstellung} konkretisiert die Problemstellung und erfasst alle zu bewältigenden Aufgaben, die zur Erfüllung der
Zielsetzung notwendig sind. In Kapitel~\ref{cha:methodik_und_modelle} wird die genaue Umsetzung zur synthetischen Datengenerierung beschrieben, sowie die 
konzipierten Modellansätze und der Versuchsaufbau erläutert, der zur Evaluation der Modelle dient. Kapitel~\ref{cha:ergebnisse_und_diskussion} präsentiert 
die erzielten Ergebnisse und diskutiert diese im Kontext der Forschungsfragen. Abschließend fasst Kapitel~\ref{cha:fazit} die zentralen Erkenntnisse der Arbeit 
zusammen, reflektiert deren Bedeutung und gibt einen Ausblick auf mögliche zukünftige Forschungsrichtungen.
