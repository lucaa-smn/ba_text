...
\include{Inhalt/VerwandteArbeiten}

\include{Inhalt/Problemstellung}

\include{Inhalt/Methodik_und_Modelle}

\include{Inhalt/Ergebnisse_und_Diskussion}
...
% --------------------------------------------------------------------------
% Literaturverzeichnis mit biblatex einbinden
